...
namespace AutoNexus.Features
{
    public class AutoPot
    {
        ...
        private void UpdateAutoPotToggleKey()
        {
            ...
            {
                _logger.Error(
                    $"Invalid AutoPotToggleKey '{_config.AutoPotToggleKey.Value}' in config. Reverting to default 'H'. Exception: {ex.Message}");
        ...
        private bool TryInitializePlayer()
        {
            ...
            _entityComponent = _playerCharacter.GetComponent<Entity>();
